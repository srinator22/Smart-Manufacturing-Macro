...
Required for start to complete: git; a working language toolchain; ability to execute scripts/check.sh end to end. Native Windows shells run it via scripts/check.ps1, which locates Git Bash and forwards to the same script.
